...
void rl_DrawSphereEx(rl_Vector3 centerPos, float radius, int rings, int slices, rl_Color color)
{
    ...
    rlPushMatrix();
        ...
        rlBegin(RL_TRIANGLES);
            ...
            for (int i = 0; i < (rings + 2); i++)
            {
                ...
                {
                    rlVertex3f(cosf(rl_DEG2RAD*(270 + (180.0f/(rings + 1))*i))*sinf(rl_DEG2RAD*(360.0f*j/slices)),
                               sinf(rl_DEG2RAD*(270 + (180.0f/(rings + 1))*i)),
                               cosf(rl_DEG2RAD*(270 + (180.0f/(rings + 1))*i))*cosf(rl_DEG2RAD*(360.0f*j/slices)));
                    rlVertex3f(cosf(rl_DEG2RAD*(270 + (180.0f/(rings + 1))*(i + 1)))*sinf(rl_DEG2RAD*(360.0f*(j + 1)/slices)),
                               sinf(rl_DEG2RAD*(270 + (180.0f/(rings + 1))*(i + 1))),
                               cosf(rl_DEG2RAD*(270 + (180.0f/(rings + 1))*(i + 1)))*cosf(rl_DEG2RAD*(360.0f*(j + 1)/slices)));
                    rlVertex3f(cosf(rl_DEG2RAD*(270 + (180.0f/(rings + 1))*(i + 1)))*sinf(rl_DEG2RAD*(360.0f*j/slices)),
                               sinf(rl_DEG2RAD*(270 + (180.0f/(rings + 1))*(i + 1))),
                               cosf(rl_DEG2RAD*(270 + (180.0f/(rings + 1))*(i + 1)))*cosf(rl_DEG2RAD*(360.0f*j/slices)));

                    rlVertex3f(cosf(rl_DEG2RAD*(270 + (180.0f/(rings + 1))*i))*sinf(rl_DEG2RAD*(360.0f*j/slices)),
                               sinf(rl_DEG2RAD*(270 + (180.0f/(rings + 1))*i)),
                               cosf(rl_DEG2RAD*(270 + (180.0f/(rings + 1))*i))*cosf(rl_DEG2RAD*(360.0f*j/slices)));
                    rlVertex3f(cosf(rl_DEG2RAD*(270 + (180.0f/(rings + 1))*(i)))*sinf(rl_DEG2RAD*(360.0f*(j + 1)/slices)),
                               sinf(rl_DEG2RAD*(270 + (180.0f/(rings + 1))*(i))),
                               cosf(rl_DEG2RAD*(270 + (180.0f/(rings + 1))*(i)))*cosf(rl_DEG2RAD*(360.0f*(j + 1)/slices)));
                    rlVertex3f(cosf(rl_DEG2RAD*(270 + (180.0f/(rings + 1))*(i + 1)))*sinf(rl_DEG2RAD*(360.0f*(j + 1)/slices)),
                               sinf(rl_DEG2RAD*(270 + (180.0f/(rings + 1))*(i + 1))),
                               cosf(rl_DEG2RAD*(270 + (180.0f/(rings + 1))*(i + 1)))*cosf(rl_DEG2RAD*(360.0f*(j + 1)/slices)));
                }
    ...
    rlPushMatrix();
        ...
        rlBegin(RL_TRIANGLES);
            ...
            float ringangle = rl_DEG2RAD*(180.0f/(rings + 1)); // Angle between latitudinal parallels
            float sliceangle = rl_DEG2RAD*(360.0f/slices); // Angle between longitudinal meridians
    ...
    rlPushMatrix();
        ...
        rlBegin(RL_TRIANGLES);
            ...
            if (radiusTop > 0)
            {
                ...
                {
                    rlVertex3f(sinf(rl_DEG2RAD*i*angleStep)*radiusBottom, 0, cosf(rl_DEG2RAD*i*angleStep)*radiusBottom); //Bottom Left
                    rlVertex3f(sinf(rl_DEG2RAD*(i+1)*angleStep)*radiusBottom, 0, cosf(rl_DEG2RAD*(i+1)*angleStep)*radiusBottom); //Bottom Right
                    rlVertex3f(sinf(rl_DEG2RAD*(i+1)*angleStep)*radiusTop, height, cosf(rl_DEG2RAD*(i+1)*angleStep)*radiusTop); //Top Right

                    rlVertex3f(sinf(rl_DEG2RAD*i*angleStep)*radiusTop, height, cosf(rl_DEG2RAD*i*angleStep)*radiusTop); //Top Left
                    rlVertex3f(sinf(rl_DEG2RAD*i*angleStep)*radiusBottom, 0, cosf(rl_DEG2RAD*i*angleStep)*radiusBottom); //Bottom Left
                    rlVertex3f(sinf(rl_DEG2RAD*(i+1)*angleStep)*radiusTop, height, cosf(rl_DEG2RAD*(i+1)*angleStep)*radiusTop); //Top Right
                }
                ...
                for (int i = 0; i < sides; i++)
                {
                    ...
                    rlVertex3f(sinf(rl_DEG2RAD*i*angleStep)*radiusTop, height, cosf(rl_DEG2RAD*i*angleStep)*radiusTop);
                    rlVertex3f(sinf(rl_DEG2RAD*(i+1)*angleStep)*radiusTop, height, cosf(rl_DEG2RAD*(i+1)*angleStep)*radiusTop);
                }
            }
            else
            {
                ...
                {
                    rlVertex3f(0, height, 0);
                    rlVertex3f(sinf(rl_DEG2RAD*i*angleStep)*radiusBottom, 0, cosf(rl_DEG2RAD*i*angleStep)*radiusBottom);
                    rlVertex3f(sinf(rl_DEG2RAD*(i+1)*angleStep)*radiusBottom, 0, cosf(rl_DEG2RAD*(i+1)*angleStep)*radiusBottom);
                }
            }
...
void rl_DrawCylinderEx(rl_Vector3 startPos, rl_Vector3 endPos, float startRadius, float endRadius, int sides, rl_Color color)
{
    ...
    float baseAngle = (2.0f*rl_PI)/sides;
...
void rl_DrawCapsule(rl_Vector3 startPos, rl_Vector3 endPos, float radius, int slices, int rings, rl_Color color)
{
    ...
    float baseSliceAngle = (2.0f*rl_PI)/slices;
    float baseRingAngle  = rl_PI*0.5f/rings;
...
bool rl_IsModelValid(rl_Model model)
{
    bool result = false;
    ...
    // but some VBOs could not be used, it depends on rl_Mesh vertex data
...
void rl_DrawMesh(rl_Mesh mesh, rl_Material material, rl_Matrix transform)
{
    ...
    if (mesh.texcoords && material.maps[rl_MATERIAL_MAP_DIFFUSE].texture.id > 0) rlEnableTexture(material.maps[rl_MATERIAL_MAP_DIFFUSE].texture.id);
    ...
    rlPushMatrix();
        ...
        rlColor4ub(material.maps[rl_MATERIAL_MAP_DIFFUSE].color.r,
                   material.maps[rl_MATERIAL_MAP_DIFFUSE].color.g,
                   material.maps[rl_MATERIAL_MAP_DIFFUSE].color.b,
                   material.maps[rl_MATERIAL_MAP_DIFFUSE].color.a);
    ...
    {
        float values[4] = {
            (float)material.maps[rl_MATERIAL_MAP_DIFFUSE].color.r/255.0f,
            (float)material.maps[rl_MATERIAL_MAP_DIFFUSE].color.g/255.0f,
            (float)material.maps[rl_MATERIAL_MAP_DIFFUSE].color.b/255.0f,
            (float)material.maps[rl_MATERIAL_MAP_DIFFUSE].color.a/255.0f
        };
    ...
    {
        float values[4] = {
            (float)material.maps[rl_MATERIAL_MAP_SPECULAR].color.r/255.0f,
            (float)material.maps[rl_MATERIAL_MAP_SPECULAR].color.g/255.0f,
            (float)material.maps[rl_MATERIAL_MAP_SPECULAR].color.b/255.0f,
            (float)material.maps[rl_MATERIAL_MAP_SPECULAR].color.a/255.0f
        };
    ...
    for (int i = 0; i < MAX_MATERIAL_MAPS; i++)
    {
        if (material.maps[i].texture.id > 0)
        {
            ...
            rlSetUniform(material.shader.locs[rl_SHADER_LOC_MAP_DIFFUSE + i], &i, SHADER_UNIFORM_INT, 1);
        }
    }
...
void rl_DrawMeshInstanced(rl_Mesh mesh, rl_Material material, const rl_Matrix *transforms, int instances)
{
    ...
    rl_float16 *instanceTransforms = NULL;
    ...
    instanceTransforms = (rl_float16 *)RL_MALLOC(instances*sizeof(rl_float16));

    // Fill buffer with instances transformations as rl_float16 arrays
    ...
    instancesVboId = rlLoadVertexBuffer(instanceTransforms, instances*sizeof(rl_float16), false);
    ...
    for (unsigned int i = 0; i < 4; i++)
    {
        ...
        rlSetVertexAttribute(material.shader.locs[SHADER_LOC_VERTEX_INSTANCE_TX] + i, 4, RL_FLOAT, 0, sizeof(rl_Matrix), i*sizeof(rl_Vector4));
...
static void ProcessMaterialsOBJ(rl_Material *materials, tinyobj_material_t *mats, int materialCount)
{
    ...
    for (int m = 0; m < materialCount; m++)
    {
        ...
        // NOTE: Uses default shader, which only supports rl_MATERIAL_MAP_DIFFUSE
        ...
        materials[m].maps[rl_MATERIAL_MAP_DIFFUSE].texture = (rl_Texture2D){ rlGetTextureIdDefault(), 1, 1, 1, PIXELFORMAT_UNCOMPRESSED_R8G8B8A8 };

        if (mats[m].diffuse_texname != NULL) materials[m].maps[rl_MATERIAL_MAP_DIFFUSE].texture = rl_LoadTexture(mats[m].diffuse_texname);  //char *diffuse_texname; // map_Kd
        else materials[m].maps[rl_MATERIAL_MAP_DIFFUSE].color = (rl_Color){ (unsigned char)(mats[m].diffuse[0]*255.0f), (unsigned char)(mats[m].diffuse[1]*255.0f), (unsigned char)(mats[m].diffuse[2]*255.0f), 255 }; //float diffuse[3];
        materials[m].maps[rl_MATERIAL_MAP_DIFFUSE].value = 0.0f;

        if (mats[m].specular_texname != NULL) materials[m].maps[rl_MATERIAL_MAP_SPECULAR].texture = rl_LoadTexture(mats[m].specular_texname);  //char *specular_texname; // map_Ks
        materials[m].maps[rl_MATERIAL_MAP_SPECULAR].color = (rl_Color){ (unsigned char)(mats[m].specular[0]*255.0f), (unsigned char)(mats[m].specular[1]*255.0f), (unsigned char)(mats[m].specular[2]*255.0f), 255 }; //float specular[3];
        materials[m].maps[rl_MATERIAL_MAP_SPECULAR].value = 0.0f;
...
rl_Material *rl_LoadMaterials(const char *fileName, int *materialCount)
{
    ...
    if (rl_IsFileExtension(fileName, ".mtl"))
    {
        ...
        materials = (rl_Material *)RL_MALLOC(count*sizeof(rl_Material));
...
rl_Material rl_LoadMaterialDefault(void)
{
    ...
    material.maps[rl_MATERIAL_MAP_DIFFUSE].texture = (rl_Texture2D){ rlGetTextureIdDefault(), 1, 1, 1, PIXELFORMAT_UNCOMPRESSED_R8G8B8A8 };
    //material.maps[MATERIAL_MAP_NORMAL].texture;         // NOTE: By default, not set
    //material.maps[rl_MATERIAL_MAP_SPECULAR].texture;       // NOTE: By default, not set

    material.maps[rl_MATERIAL_MAP_DIFFUSE].color = rl_WHITE;    // Diffuse color
    material.maps[rl_MATERIAL_MAP_SPECULAR].color = rl_WHITE;   // Specular color

    return material;
}

// Check if a material is valid (map textures loaded in GPU)
bool rl_IsMaterialValid(rl_Material material)
{
    bool result = false;
...
// Set texture for a material map type (rl_MATERIAL_MAP_DIFFUSE, rl_MATERIAL_MAP_SPECULAR...)
...
void rl_UpdateModelAnimationBones(rl_Model model, rl_ModelAnimation anim, int frame)
{
    if ((anim.frameCount > 0) && (anim.bones != NULL) && (anim.framePoses != NULL))
    {
        ...
        if (firstMeshWithBones != -1)
        {
            ...
            {
                rl_Transform *bindTransform = &model.bindPose[boneId];
                rl_Matrix bindMatrix = MatrixMultiply(MatrixMultiply(
                    MatrixScale(bindTransform->scale.x, bindTransform->scale.y, bindTransform->scale.z),
                    QuaternionToMatrix(bindTransform->rotation)),
                    MatrixTranslate(bindTransform->translation.x, bindTransform->translation.y, bindTransform->translation.z));

                rl_Transform *targetTransform = &anim.framePoses[frame][boneId];
                rl_Matrix targetMatrix = MatrixMultiply(MatrixMultiply(
            ...
            // NOTE: Using deep copy because shallow copy results in double free with 'rl_UnloadModel()'
...
{
    rl_UpdateModelAnimationBones(model,anim,frame);
...
rl_Mesh rl_GenMeshPoly(int sides, float radius)
{
    ...
    for (int v = 0; v < vertexCount - 2; v += 3)
    {
        ...
        vertices[v + 1] = (rl_Vector3){ sinf(rl_DEG2RAD*d)*radius, 0.0f, cosf(rl_DEG2RAD*d)*radius };
        vertices[v + 2] = (rl_Vector3){ sinf(rl_DEG2RAD*(d+dStep))*radius, 0.0f, cosf(rl_DEG2RAD*(d+dStep))*radius };
        d += dStep;
    }
...
rl_Mesh rl_GenMeshCylinder(float radius, float height, int slices)
{
    ...
    if (slices >= 3)
    {
        ...
        par_shapes_rotate(capTop, 90*rl_DEG2RAD, (float[]){ 0, 1, 0 });
        ...
        par_shapes_rotate(capBottom, -90*rl_DEG2RAD, (float[]){ 0, 1, 0 });
...
rl_Mesh rl_GenMeshCone(float radius, float height, int slices)
{
    ...
    if (slices >= 3)
    {
        ...
        par_shapes_rotate(cone, -rl_PI/2.0f, (float[]){ 1, 0, 0 });
        par_shapes_rotate(cone, rl_PI/2.0f, (float[]){ 0, 1, 0 });
...
void rl_GenMeshTangents(rl_Mesh *mesh)
{
    ...
    rl_Vector3 *tan1 = (rl_Vector3 *)RL_CALLOC(mesh->vertexCount, sizeof(rl_Vector3));
    rl_Vector3 *tan2 = (rl_Vector3 *)RL_CALLOC(mesh->vertexCount, sizeof(rl_Vector3));
    ...
    for (int t = 0; t < mesh->triangleCount; t++)
    {
        ...
        rl_Vector3 v1 = { mesh->vertices[i0*3 + 0], mesh->vertices[i0*3 + 1], mesh->vertices[i0*3 + 2] };
        rl_Vector3 v2 = { mesh->vertices[i1*3 + 0], mesh->vertices[i1*3 + 1], mesh->vertices[i1*3 + 2] };
        rl_Vector3 v3 = { mesh->vertices[i2*3 + 0], mesh->vertices[i2*3 + 1], mesh->vertices[i2*3 + 2] };

        // Get triangle texcoords
        rl_Vector2 uv1 = { mesh->texcoords[i0*2 + 0], mesh->texcoords[i0*2 + 1] };
        rl_Vector2 uv2 = { mesh->texcoords[i1*2 + 0], mesh->texcoords[i1*2 + 1] };
        rl_Vector2 uv3 = { mesh->texcoords[i2*2 + 0], mesh->texcoords[i2*2 + 1] };
    ...
    for (int i = 0; i < mesh->vertexCount; i++)
    {
        ...
        if (Vector3Length(tangent) < 0.0001f)
        {
            ...
            if (fabsf(normal.z) > 0.707f) tangent = (rl_Vector3){ 1.0f, 0.0f, 0.0f };
            else tangent = Vector3Normalize((rl_Vector3){ -normal.y, normal.x, 0.0f });
        ...
        // T_prime = T - N*dot(N, T)
        rl_Vector3 orthogonalized = Vector3Subtract(tangent, Vector3Scale(normal, Vector3DotProduct(normal, tangent)));

        // Handle cases where orthogonalized vector is too small
        if (Vector3Length(orthogonalized) < 0.0001f)
        {
            // Create a tangent perpendicular to the normal
            if (fabsf(normal.z) > 0.707f) orthogonalized = (rl_Vector3){ 1.0f, 0.0f, 0.0f };
            else orthogonalized = Vector3Normalize((rl_Vector3){ -normal.y, normal.x, 0.0f });
        }
        else
        {
...
void rl_DrawModelEx(rl_Model model, rl_Vector3 position, rl_Vector3 rotationAxis, float rotationAngle, rl_Vector3 scale, rl_Color tint)
{
    ...
    rl_Matrix matRotation = MatrixRotate(rotationAxis, rotationAngle*rl_DEG2RAD);
    ...
    for (int i = 0; i < model.meshCount; i++)
    {
        rl_Color color = model.materials[model.meshMaterial[i]].maps[rl_MATERIAL_MAP_DIFFUSE].color;
        ...
        model.materials[model.meshMaterial[i]].maps[rl_MATERIAL_MAP_DIFFUSE].color = colorTint;
        rl_DrawMesh(model.meshes[i], model.materials[model.meshMaterial[i]], model.transform);
        model.materials[model.meshMaterial[i]].maps[rl_MATERIAL_MAP_DIFFUSE].color = color;
    }
}
...
// Draw a model points
// WARNING: OpenGL ES 2.0 does not support point mode drawing
void rl_DrawModelPoints(rl_Model model, rl_Vector3 position, float scale, rl_Color tint)
{
    rlEnablePointMode();
...
// Draw a model points
// WARNING: OpenGL ES 2.0 does not support point mode drawing
void rl_DrawModelPointsEx(rl_Model model, rl_Vector3 position, rl_Vector3 rotationAxis, float rotationAngle, rl_Vector3 scale, rl_Color tint)
{
    rlEnablePointMode();
    rlDisableBackfaceCulling();
...
void rl_DrawBillboardPro(rl_Camera camera, rl_Texture2D texture, rl_Rectangle source, rl_Vector3 position, rl_Vector3 up, rl_Vector2 size, rl_Vector2 origin, float rotation, rl_Color tint)
{
    ...
    for (int i = 0; i < 4; i++)
    {
        ...
        if (rotation != 0.0) points[i] = Vector3RotateByAxisAngle(points[i], forward, rotation*rl_DEG2RAD);
...
{
    #define rl_EPSILON 0.000001f        // A small number
    ...
    // Avoid culling!
    if ((det > -rl_EPSILON) && (det < rl_EPSILON)) return collision;
...
static rl_Model LoadOBJ(const char *fileName)
{
    ...
    strncpy(currentDir, rl_GetWorkingDirectory(), MAX_FILEPATH_LENGTH - 1); // Save current working directory
    ...
    #else
        if (objAttributes.texcoords != NULL && objAttributes.num_texcoords > 0) model.meshes[i].texcoords = (float *)rl_MemAlloc(sizeof(float)*vertexCount*2);
...
static rl_Model LoadIQM(const char *fileName)
{
    ...
    */
    ...
    model.bones = (rl_BoneInfo *)RL_MALLOC(iqmHeader->num_joints*sizeof(rl_BoneInfo));
    model.bindPose = (rl_Transform *)RL_MALLOC(iqmHeader->num_joints*sizeof(rl_Transform));
    ...
    for (int i = 0; i < model.meshCount; i++)
    {
        ...
        model.meshes[i].boneMatrices = (rl_Matrix *)RL_CALLOC(model.meshes[i].boneCount, sizeof(rl_Matrix));
...
static rl_ModelAnimation *LoadModelAnimationsIQM(const char *fileName, int *animCount)
{
    ...
    *animCount = iqmHeader->num_anims;
    ...
    rl_ModelAnimation *animations = (rl_ModelAnimation *)RL_MALLOC(iqmHeader->num_anims*sizeof(rl_ModelAnimation));
    ...
    for (unsigned int a = 0; a < iqmHeader->num_anims; a++)
    {
        ...
        animations[a].bones = (rl_BoneInfo *)RL_MALLOC(iqmHeader->num_poses*sizeof(rl_BoneInfo));
        animations[a].framePoses = (rl_Transform **)RL_MALLOC(anim[a].num_frames*sizeof(rl_Transform *));
        ...
        for (unsigned int j = 0; j < anim[a].num_frames; j++) animations[a].framePoses[j] = (rl_Transform *)RL_MALLOC(iqmHeader->num_poses*sizeof(rl_Transform));
...
{
    rl_UnloadFileData((unsigned char *)data);
}
...
static rl_Image LoadImageFromCgltfImage(cgltf_image *cgltfImage, const char *texPath)
{
    ...
    else if ((cgltfImage->buffer_view != NULL) && (cgltfImage->buffer_view->buffer->data != NULL))    // Check if image is provided as data buffer
    {
        ...
        {
            image = rl_LoadImageFromMemory(".png", data, (int)cgltfImage->buffer_view->size);
        }
        else if ((strcmp(cgltfImage->mime_type, "image\\/jpeg") == 0) || (strcmp(cgltfImage->mime_type, "image/jpeg") == 0))
        {
            image = rl_LoadImageFromMemory(".jpg", data, (int)cgltfImage->buffer_view->size);
        }
...
static rl_BoneInfo *LoadBoneInfoGLTF(cgltf_skin skin, int *boneCount)
{
    *boneCount = (int)skin.joints_count;
    rl_BoneInfo *bones = (rl_BoneInfo *)RL_CALLOC(skin.joints_count, sizeof(rl_BoneInfo));
...
static rl_Model LoadGLTF(const char *fileName)
{
    ...
    ***********************************************************************************************/
    ...
    if (result == cgltf_result_success)
    {
        ...
        for (unsigned int i = 0, j = 1; i < data->materials_count; i++, j++)
        {
            ...
            if (data->materials[i].has_pbr_metallic_roughness)
            {
                ...
                if (data->materials[i].pbr_metallic_roughness.metallic_roughness_texture.texture)
                {
                    ...
                    {
                        rl_Image imMetallic = { 0 };
                        rl_Image imRoughness = { 0 };
                        ...
                        for (int x = 0; x < imRoughness.width; x++)
                        {
                            ...
                            {
                                rl_Color color = rl_GetImageColor(imMetallicRoughness, x, y);
                        ...
                        model.materials[j].maps[MATERIAL_MAP_ROUGHNESS].texture = rl_LoadTextureFromImage(imRoughness);
                        model.materials[j].maps[MATERIAL_MAP_METALNESS].texture = rl_LoadTextureFromImage(imMetallic);

                        rl_UnloadImage(imRoughness);
                        rl_UnloadImage(imMetallic);
        ...
        //  - The local-to-world transform of each node is used to transform the points/normals/tangents of the created rl_Mesh(es)
        //  - Any glTF mesh linked from more than one Node (i.e. instancing) is turned into multiple rl_Mesh's, as each Node will have its own transform applied
        //
                    ...
                    else if (mesh->primitives[p].attributes[j].type == cgltf_attribute_type_normal)   // NORMAL, vec3, float
                    {
                        ...
                        else
                        {
                            ...
                            else if ((attribute->type == cgltf_type_vec3) && (attribute->component_type == cgltf_component_type_r_16))
                            {
                                ...
                                for (unsigned int k = 0; k < attribute->count; k++)
                                {
                                    rl_Vector3 nt = Vector3Normalize(Vector3Transform((rl_Vector3){ normals[3*k], normals[3*k + 1], normals[3*k + 2] }, worldMatrixNormals));
                                    normals[3*k] = nt.x;
                                    normals[3*k + 1] = nt.y;
                                    normals[3*k + 2] = nt.z;
                                }
                    ...
                    else if (mesh->primitives[p].attributes[j].type == cgltf_attribute_type_tangent)   // TANGENT, vec4, float, w is tangent basis sign
                    {
                        ...
                        else
                        {
                            if ((attribute->type == cgltf_type_vec4) && (attribute->component_type == cgltf_component_type_r_32f))
                            {
                                ...
                                for (unsigned int k = 0; k < attribute->count; k++)
                                {
                                    rl_Vector3 tt = Vector3Transform((rl_Vector3){ tangents[4*k], tangents[4*k+1], tangents[4*k+2] }, worldMatrix);
                                    tangents[4*k] = tt.x;
                                    tangents[4*k+1] = tt.y;
                                    tangents[4*k+2] = tt.z;
                                }
        ...
        if (data->skins_count > 0)
        {
            ...
            model.bindPose = (rl_Transform *)RL_MALLOC(model.boneCount*sizeof(rl_Transform));
        ...
        for (unsigned int i = 0; i < data->nodes_count; i++)
        {
            ...
            for (unsigned int p = 0; p < mesh->primitives_count; p++)
            {
                ...
                model.meshes[meshIndex].boneMatrices = (rl_Matrix *)RL_CALLOC(model.meshes[meshIndex].boneCount, sizeof(rl_Matrix));
...
static bool GetPoseAtTimeGLTF(cgltf_interpolation_type interpolationType, cgltf_accessor *input, cgltf_accessor *output, float time, void *data)
{
    ...
    float duration = fmaxf((tend - tstart), rl_EPSILON);
    ...
    if (result == cgltf_result_success)
    {
        if (data->skins_count > 0)
        {
            ...
            *animCount = (int)data->animations_count;
            animations = (rl_ModelAnimation *)RL_CALLOC(data->animations_count, sizeof(rl_ModelAnimation));

            rl_Transform worldTransform = { 0 };
            ...
            for (unsigned int i = 0; i < data->animations_count; i++)
            {
                ...
                animations[i].framePoses = (rl_Transform **)RL_MALLOC(animations[i].frameCount*sizeof(rl_Transform *));

                for (int j = 0; j < animations[i].frameCount; j++)
                {
                    animations[i].framePoses[j] = (rl_Transform *)RL_MALLOC(animations[i].boneCount*sizeof(rl_Transform));
                    ...
                    rl_Transform* root = &animations[i].framePoses[j][0];
    ...
    if (fileData != NULL)
    {
        ...
        */
        ...
        for (i = l = 0, k = -1; i < (int)m3d->numface; i++, l++)
        {
            ...
            if (mi != m3d->face[i].materialid)
            {
                ...
                if (k + 1 >= model.meshCount)
                {
                    ...
                    rl_Mesh *tempMeshes = (rl_Mesh *)RL_CALLOC(model.meshCount, sizeof(rl_Mesh));
                    memcpy(tempMeshes, model.meshes, (model.meshCount - 1)*sizeof(rl_Mesh));
                    RL_FREE(model.meshes);
        ...
        for (i = 0; i < (int)m3d->nummaterial; i++)
        {
            ...
            for (j = 0; j < m3d->material[i].numprop; j++)
            {
                ...
                switch (prop->type)
                {
                    case m3dp_Kd:
                    {
                        memcpy(&model.materials[i + 1].maps[rl_MATERIAL_MAP_DIFFUSE].color, &prop->value.color, 4);
                        model.materials[i + 1].maps[rl_MATERIAL_MAP_DIFFUSE].value = 0.0f;
                    } break;
                    case m3dp_Ks:
                    {
                        memcpy(&model.materials[i + 1].maps[rl_MATERIAL_MAP_SPECULAR].color, &prop->value.color, 4);
                    } break;
                    case m3dp_Ns:
                    {
                        model.materials[i + 1].maps[rl_MATERIAL_MAP_SPECULAR].value = prop->value.fnum;
                    } break;
                    case m3dp_Ke:
                    {
                    ...
                    default:
                    {
                        if (prop->type >= 128)
                        {
                            ...
                            switch (prop->type)
                            {
                                case m3dp_map_Kd: model.materials[i + 1].maps[rl_MATERIAL_MAP_DIFFUSE].texture = rl_LoadTextureFromImage(image); break;
                                case m3dp_map_Ks: model.materials[i + 1].maps[rl_MATERIAL_MAP_SPECULAR].texture = rl_LoadTextureFromImage(image); break;
        ...
        if (m3d->numbone)
        {
            ...
            model.bones = (rl_BoneInfo *)RL_CALLOC(model.boneCount, sizeof(rl_BoneInfo));
            model.bindPose = (rl_Transform *)RL_CALLOC(model.boneCount, sizeof(rl_Transform));
...
static rl_ModelAnimation *LoadModelAnimationsM3D(const char *fileName, int *animCount)
{
    ...
    *animCount = 0;
    ...
    if (fileData != NULL)
    {
        ...
        animations = (rl_ModelAnimation *)RL_CALLOC(m3d->numaction, sizeof(rl_ModelAnimation));
        *animCount = m3d->numaction;
        ...
        for (unsigned int a = 0; a < m3d->numaction; a++)
        {
            ...
            animations[a].bones = (rl_BoneInfo *)RL_MALLOC((m3d->numbone + 1)*sizeof(rl_BoneInfo));
            animations[a].framePoses = (rl_Transform **)RL_MALLOC(animations[a].frameCount*sizeof(rl_Transform *));
            ...
            {
                animations[a].framePoses[i] = (rl_Transform *)RL_MALLOC((m3d->numbone + 1)*sizeof(rl_Transform));
