...
#define rl_CloseWindow CloseWindowWin32
#define rl_Rectangle RectangleWin32
#define rl_ShowCursor ShowCursorWin32
...
#undef rl_CloseWindow      // raylib symbol collision
#undef rl_Rectangle        // raylib symbol collision
#undef rl_ShowCursor       // raylib symbol collision
#undef rl_LoadImage        // raylib symbol collision
#undef rl_DrawText         // raylib symbol collision
#undef DrawTextA
#undef DrawTextW
#undef rl_DrawTextEx       // raylib symbol collision
#undef DrawTextExA
#undef DrawTextExW
...
static rl_KeyboardKey GetKeyFromWparam(WPARAM wparam)
{
    switch (wparam)
    {
...
// NOTE: Required by rl_GetMonitorCount()
...
// NOTE: Required by rl_GetCurrentMonitor()
...
{
    if (CORE.Window.flags & FLAG_BORDERLESS_WINDOWED_MODE) rl_ClearWindowState(FLAG_BORDERLESS_WINDOWED_MODE);
    else rl_SetWindowState(FLAG_BORDERLESS_WINDOWED_MODE);
}

// Set window state: maximized, if resizable
void rl_MaximizeWindow(void)
{
    rl_SetWindowState(FLAG_WINDOW_MAXIMIZED);
}

// Set window state: minimized
void rl_MinimizeWindow(void)
{
    rl_SetWindowState(FLAG_WINDOW_MINIMIZED);
}
...
void rl_RestoreWindow(void)
{
    if ((CORE.Window.flags & FLAG_WINDOW_MAXIMIZED) &&
        (CORE.Window.flags & FLAG_WINDOW_MINIMIZED)) rl_ClearWindowState(FLAG_WINDOW_MINIMIZED);
    else rl_ClearWindowState(FLAG_WINDOW_MINIMIZED | FLAG_WINDOW_MAXIMIZED);
}
...
{
    // TODO: Implement rl_SetWindowIcons()
}
...
{
    TRACELOG(LOG_WARNING, "rl_SetWindowMonitor not implemented");
}

// Set window minimum dimensions (FLAG_WINDOW_RESIZABLE)
void rl_SetWindowMinSize(int width, int height)
{
    TRACELOG(LOG_WARNING, "rl_SetWindowMinSize not implemented");
...
{
    TRACELOG(LOG_WARNING, "rl_SetWindowMaxSize not implemented");
...
{
    TRACELOG(LOG_WARNING, "rl_SetWindowSize not implemented");
}

// Set window opacity, value opacity is between 0.0 and 1.0
void rl_SetWindowOpacity(float opacity)
{
    TRACELOG(LOG_WARNING, "rl_SetWindowOpacity not implemented");
}

// Set window focused
void rl_SetWindowFocused(void)
{
    TRACELOG(LOG_WARNING, "rl_SetWindowFocused not implemented");
}
...
{
    TRACELOG(LOG_WARNING, "rl_GetMonitorPosition not implemented");
...
{
    TRACELOG(LOG_WARNING, "rl_GetMonitorWidth not implemented");
    return 0;
}
...
{
    TRACELOG(LOG_WARNING, "rl_GetMonitorHeight not implemented");
    return 0;
}
...
{
    TRACELOG(LOG_WARNING, "rl_GetMonitorPhysicalWidth not implemented");
    return 0;
}
...
{
    TRACELOG(LOG_WARNING, "rl_GetMonitorPhysicalHeight not implemented");
    return 0;
}
...
{
    TRACELOG(LOG_WARNING, "rl_GetMonitorRefreshRate not implemented");
    return 0;
}
...
{
    TRACELOG(LOG_WARNING, "rl_GetMonitorName not implemented");
    return 0;
}
...
{
    TRACELOG(LOG_WARNING, "rl_GetWindowPosition not implemented");
    return (rl_Vector2){ 0, 0 };
}
...
rl_Vector2 rl_GetWindowScaleDPI(void)
{
    ...
    return (rl_Vector2){ scale, scale };
}

// Set clipboard text content
void rl_SetClipboardText(const char *text)
{
    TRACELOG(LOG_WARNING, "rl_SetClipboardText not implemented");
}

// Get clipboard text content
const char *rl_GetClipboardText(void)
{
    TRACELOG(LOG_WARNING, "rl_GetClipboardText not implemented");
    return NULL;
}
...
{
    // NOTE: We use SetCursor() instead of rl_ShowCursor() because
...
void rl_DisableCursor(void)
{
    if (!CORE.Input.Mouse.cursorLocked)
    {
        ...
        CORE.Input.Mouse.previousPosition = (rl_Vector2){ 0, 0 };
        CORE.Input.Mouse.currentPosition = (rl_Vector2){ 0, 0 };
        rl_HideCursor();
...
{
    TRACELOG(LOG_WARNING, "rl_SetGamepadMappings not implemented");
...
{
    TRACELOG(LOG_WARNING, "rl_SetGamepadVibration not implemented");
}
...
void rl_SetMousePosition(int x, int y)
{
    if (!CORE.Input.Mouse.cursorLocked)
    {
        ...
        TRACELOG(LOG_WARNING, "rl_SetMousePosition not implemented");
    }
...
{
    TRACELOG(LOG_WARNING, "rl_GetKeyName not implemented");
    return NULL;
}
...
static void HandleKey(WPARAM wparam, LPARAM lparam, char state)
{
    rl_KeyboardKey key = GetKeyFromWparam(wparam);
